...
void DeleteNode(Isi_Tree X, infotype value);
/* Menghapus node dengan nilai tertentu dari pohon */
/* IS : Pohon terdefinisi */
/* FS : Node dengan nilai tertentu dihapus dari pohon */
